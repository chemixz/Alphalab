...
class ProyectsControllerTest < ActionController::TestCase
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post :create, proyect: { body: @proyect.body, finish_date: @proyect.finish_date, start_date: @proyect.start_date, state: @proyect.state, title: @proyect.title, user_id: @proyect.user_id }
    end
  ...
  test "should update proyect" do
    patch :update, id: @proyect, proyect: { body: @proyect.body, finish_date: @proyect.finish_date, start_date: @proyect.start_date, state: @proyect.state, title: @proyect.title, user_id: @proyect.user_id }
    assert_redirected_to proyect_path(assigns(:proyect))
  end
